...
if ( ! function_exists( 'theme_customize_preview_js' ) ) {
	function theme_customize_preview_js() {
		wp_enqueue_script( 'theme_customizer', get_template_directory_uri() . '/core/customizer/js/customizer.min.js', array( 'customize-preview' ), '1.15', true );
	}
}
 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'theme_sanitize_hex_color' ) ) {
	function theme_sanitize_hex_color( $color ) {
		if ( '' === $color ) {
			return '';
        }
 ...
 * @since  1.3.0
 */
if ( ! function_exists( 'theme_sanitize_choices' ) ) {
    function theme_sanitize_choices( $input, $setting ) {
 ...
 * @since 1.0.3
 */
if ( ! function_exists( 'theme_sanitize_layout' ) ) {
    function theme_sanitize_layout( $input ) {
        $valid = array(
            'right' => 'Right',
            'left'  => 'Left',
            );
 ...
 * @since  1.0.0
 */
function theme_layout_class( $classes ) {
 ...
 * @since  1.0.0
 */
function theme_adjust_color_brightness( $hex, $steps ) {
 ...
 * @since  1.5.0
 */
function theme_customizer_custom_control_css() {
    ?>
    <style>
