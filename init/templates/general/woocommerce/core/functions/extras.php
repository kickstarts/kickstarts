...
/**
 * Check whether the Theme Customizer settings ar enabled
 * @return boolean
 * @since  1.1.2
 */
function is_theme_customizer_enabled() {
	return apply_filters( 'theme_customizer_enabled', true );
}
...
function theme_body_classes( $classes ) {
	 ...
	 * Or take the red pill, filter theme_make_me_cute and see how deep the rabbit hole goes...
	 */
	$cute	= apply_filters( 'theme_make_me_cute', false );
...
function theme_categorized_blog() {
	if ( false === ( $all_the_cool_cats = get_transient( 'theme_categories' ) ) ) {
		...
		set_transient( 'theme_categories', $all_the_cool_cats );
	}
