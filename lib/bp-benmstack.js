...
sh.mv('./lib/templates/benmstack/*', './');
sh.rm('-rf', ['./lib']);
sh.exec('git clone git://github.com/ambitiousframework/css.styl.git client/styles');
sh.rm('-rf', ['./client/styles/.git', './client/styles/README.md']);
