...
server.listen(app.get('port'), function() {
    ...
    process.on('SIGINT', function () {
        ...
        console.log('✓ %s has shutdown', config.locals.name.green.bold);
        console.log('✓ %s was running for %s seconds.', config.locals.name, Math.round(process.uptime()).toString().green.bold);
        process.exit(0);
    });
});
