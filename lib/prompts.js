...
exports.general = [
    {
        choices: [
            { name: 'Website (no framework)', value: 'webnone' },
            { name: 'Website (using Bootstrap)', value: 'webbs' },
            { name: 'Website (using Material Design Lite)', value: 'webmdl' },
...
exports.webapp = [
    {
        choices: [
            { name: 'Angular JS (using Bootstrap)', value: 'ngbs' },
            { name: 'Angular JS (using Angular Material)', value: 'ngmd' },
